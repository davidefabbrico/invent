...
### Association Plot and Varying Coefficients Plot
...
```{r, eval=FALSE}
plotEffectResponse(out, c(1,6), type = "linear", effect = "interaction",
                   azimut = 60, polar = 20, xtitle = "VO2max", ytitle = "age", ztitle = "BMI")
```

#### Varying Coefficients Plot
```{r, eval=FALSE}
plotEffectBeta(imod, 3, 21, type = "linear", xtitle = "age", ytitle = "VO2max")
```
