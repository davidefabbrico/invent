...
RcppExport SEXP _invent_compLinPred(SEXP nobsSEXP, SEXP eta0SEXP, SEXP X_lSEXP, SEXP beta_lSEXP, SEXP X_nlSEXP, SEXP beta_nlSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type nobs(nobsSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(compLinPred(nobs, eta0, X_l, beta_l, X_nl, beta_nl));
    return rcpp_result_gen;
END_RCPP
}
// bodyMCMC
